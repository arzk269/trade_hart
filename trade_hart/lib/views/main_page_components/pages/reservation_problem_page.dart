...
class ReservationProblemPage extends StatefulWidget {
  final Reservation reservation;
  const ReservationProblemPage({super.key, required this.reservation});

  @override
  State<ReservationProblemPage> createState() => _ReservationProblemPageState();
}

class _ReservationProblemPageState extends State<ReservationProblemPage> {
  ...
  void sendProblemMessage(String customerId, String problem) async {
    ...
    try {
      ...
      var existingConversations1 =
        ...
        'users',
        isEqualTo: [currentUserId, widget.reservation.sellerId],
      ).get();
      ...
      var existingConversations2 =
          await FirebaseFirestore.instance.collection('Conversations').where(
        'users',
        isEqualTo: [widget.reservation.sellerId, currentUserId],
      ).get();
      ...
      if (existingData1.isNotEmpty || existingData2.isNotEmpty) {
        ...
        sendNotification(
            ...
            title: "Un problème sur une Reservatione a été signalé",
            body: problem,
        ...
        final Uri params = Uri(
          ...
          query:
              'subject=Un problème à signaler ${widget.reservation.id} Ne pas changer l\'objet &body=$problem', // add subject and body here
        );
                ...
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: "J'ai un problème avec ma Reservatione.",
                        hintStyle:
