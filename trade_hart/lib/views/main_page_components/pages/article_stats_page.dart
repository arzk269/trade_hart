...
class ArticleStatsPage extends StatefulWidget {
  final String articleId;
  const ArticleStatsPage({super.key, required this.articleId});

  @override
  State<ArticleStatsPage> createState() => _ArticleStatsPageState();
}

class _ArticleStatsPageState extends State<ArticleStatsPage> {
  ...
  List<Color> gradientColors = [
    const Color.fromARGB(255, 80, 228, 255),
    const Color.fromARGB(255, 33, 150, 243),
  ];

  List<Color> gradientColors2 = [
    Color.fromARGB(255, 80, 255, 168),
    const Color.fromARGB(255, 59, 255, 73),
  ];
                        ...
                        ? (getPaymentsStream(status, timeArea)
                            .orderBy(filtre == "Montant"
                                ...
                                : (status == "Encaissées"
                                    ? "date encaissement"
                                    : "time"))
                            .where("article id", isEqualTo: widget.articleId)
                            .snapshots())
                        : getPaymentsStream(status, timeArea)
                            .where("article id", isEqualTo: widget.articleId)
                            .snapshots(),
                                                    ...
                                                    child: element.data()["status"] ==
                                                        ...
                                                        : ((element.data()["status"] ==
                                                                ...
                                                                ((element.data()["buyer confirmation status"] &&
                                                                    ...
                                                                    (!element.data()["buyer confirmation status"] &&
                                                                        element
                                                                            .data()["seller confirmation status"] &&
                                                            ...
                                                            ? TextButton(
                                                                onPressed: () {
                                                                  createTransfer(
                                                                      element.data()[
                                                                          "total amount"]*1.0/1.14 +   element.data()[
                                                                              "delivery fees"]*0.97,
                                                                      element[
                                                                          "seller stripe id"],
                                                                      element
