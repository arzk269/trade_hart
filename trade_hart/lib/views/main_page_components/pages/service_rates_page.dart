...
class ServiceRatePage extends StatefulWidget {
  ...
  const ServiceRatePage({super.key, this.service});
...
class _ServiceRatePageState extends State<ServiceRatePage> {
  ...
  void showPopup(BuildContext context, id) {
    ...
    String? serviceId;
    if (message != null) {
      serviceId = (message as Map<String, dynamic>)["serviceId"];
    }
    showDialog(
      context: context,
            ...
            TextButton(
              ...
              onPressed: () {
                FirebaseFirestore.instance
                    .collection('Services')
                    .doc(
                        widget.service != null ? widget.service!.id : serviceId)
                    .collection('Avis')
                    .doc(id)
                    .delete();
                Navigator.of(context).pop();
                    ...
                    if (aviController.text.isNotEmpty) {
                      ...
                      if (serviceId != null) {
                        var service = await FirebaseFirestore.instance
                            ...
                            .doc(serviceId)
                            .get();
                        sellerId = service.data()!["sellerId"];
                      }
                      FirebaseFirestore.instance
                          .collection("Services")
                          .doc(widget.service != null
                              ? widget.service!.id
                              : serviceId)
                          .collection("Avis")
                          .add({
                        "seller id": widget.service != null
                            ? widget.service!.sellerId
                            : sellerId,
                        "buyer id": userId,
