...
Future<void> generateAndAddPayments() async {
  CollectionReference payments =
      FirebaseFirestore.instance.collection('ReservationsPayments');
...
String getMonthOfYear(int monthIndex) {
  const List<String> monthsOfYear = [
    'Janvier', // 1
    'Février', // 2
    'Mars', // 3
    'Avril', // 4
...
class ProviderStatsPage extends StatefulWidget {
  const ProviderStatsPage({super.key});

  @override
  State<ProviderStatsPage> createState() => _ProviderStatsPageState();
}

class _ProviderStatsPageState extends State<ProviderStatsPage> {
                      ...
                      TextButton(
                          ...
                          child: Text(
                            ...
                            style: GoogleFonts.poppins(
                                ...
                                fontSize: manageHeight(context, 14.5),
                                fontWeight: FontWeight.w500),
                          )),
                      TextButton(
                          onPressed: () {
                          ...
                          children: [
                            ...
                            Center(
                                child: AppBarTitleText(
                                    ...
                                    size: manageHeight(context, 14.5)))
                          ],
                        );
                      }
                            ...
                            SizedBox(
                              ...
                              child: ListView(
                                children: [
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.all(manageWidth(context, 5)),
                                    child: Text(
                                      "Total : $totalResult \$",
                                      style: GoogleFonts.poppins(
                                          color: Colors.grey.shade800,
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    (element.data()["status"] ==
                                                        ...
                                                        : element.data()["status"],
                                                    style: GoogleFonts.poppins(
                                                        color: element.data()["status"] == "Annulé" ? Colors.red : Colors.grey.shade800,
                                                        fontSize: manageHeight(
                                                          context,
                                                          14,
                                                        ),
                                                ...
                                                SizedBox(
                                                    child: element.data()[
                                                        ...
                                                        : ((element.data()["status"] ==
                                                                    "En cours de traitement") &&
                                                                ((element.data()["buyer confirmation status"] && element.data()["seller confirmation status"] && (element.data()["time"] as Timestamp).toDate().isBefore(DateTime.now().subtract(Duration(days: 7)))) ||
                                                                    (!element.data()["buyer confirmation status"] &&
                                                                        element.data()[
                                                                            "seller confirmation status"] &&
                                                                        (element.data()["time"]
                                                            ...
                                                            : Padding(
                                                                ...
                                                                child:
                                                                    CircleAvatar(
                                                                        radius:
                                                                            12,
                                                                        backgroundColor: element.data()["status"] ==
                                                                                "Encaissé"
                                                                            ? Colors
                                                                                .green
                                                                            : Colors
                                      ...
                                      leftTitles: AxisTitles(
                                        ...
                                        getTitlesWidget:
                                          ...
                                          var style = TextStyle(
                                            ...
                                            fontSize: manageHeight(context, 9),
                                          );
                                          String text;
                                          if (value == maxResults) {
                                        ...
                                        reservedSize: manageHeight(context, 30),
                                      )),
                                    ),
